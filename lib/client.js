...
setInterval(() => {
    store.writeToFile(__dirname+"/store.json");
		...
		if(checkg.botenable==='false') return
                if (icmd && checkban.ban !== 'false') return citel.reply(`*هلا ${citel.pushName},*\n_انت محظور من استخدام اوامر البوت._\n_كلم المطور يفك عنك الحظر._`)
		}
                            ...
                            array.map(async(bg) => {
                                ...
                                if (pattern.test(chab)) {
                                    if (!isBotAdmins) {
                                        let buttonMessage = {
                                            text: `*---  حذف الرابط  ---*
@${citel.sender.split('@')[0]} تم اكتشاف رابط.
ترقيه ${tlang().title} لمشرف لحذف
الرابط المرسل.
`,
                                    ...
                                    if (patternn.test(body)) {
                                        citel.reply(`لن اطردك لأنك ارسلت رابط هذا القروب.`)
                                        return
                                    }
                                    const key = {
                                    ...
                                    citel.reply("تم حذف الرابط الآن ودع!!");
